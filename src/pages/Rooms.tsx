  ...
  return (
    <div className="bg-cream">
      <SEO
        ...
        description="Three rooms at Tamount Surf House: 8-bed dorm from €12/night, triple room from €35, double room from €30. All include breakfast, WiFi, and rooftop access."
