...
/* ═══════════════════════════════════════════════════════════════
   COPY FIELD — value with inline copy button
   ═══════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════
   BANK DETAILS CARD — reusable for payment step + confirmation
   ═══════════════════════════════════════════════════════════════ */
                        ...
                        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}
                          ...
                          <div className="text-center mb-6">
                            ...
                            <h3 className="font-display text-2xl font-bold text-stone-800 mb-2">
                              {booking.paymentChoice === "deposit" ? "Booking submitted!" : "Booking submitted!"}
                            </h3>
